<section class="content">
    ...
    <div class="box">
        ...
        <?php endif ?>
        <?php echo form_open('categorias/store', "enctype=multipart/form-data"); ?>
        <div class="box-body">
            <div class="col-md-6">
                <div class="form-group <?php echo form_error('codigo') == true ? 'has-error' : '' ?>">
                    <label for="codigo">Codigo:</label>
                    <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Codigo" required="required" value="<?php echo set_value('codigo')?:''; ?>">
