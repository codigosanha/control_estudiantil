<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Editar Módulo Profesional</h3>
        ...
        <?php endif ?>
        <?php echo form_open('modulos/update', "enctype=multipart/form-data"); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?php echo form_error('nombre') == true ? 'has-error' : '' ?>">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" required="required" value="<?php echo set_value('nombre')?:$modulo->nombre; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select name="especialidad_id" id="especialidad_id" class="form-control" required="required">
                            ...
                            <?php foreach ($especialidades as $especialidad): ?>
                                <?php
                                    $selected = '';
                                    if ($modulo->especialidad_id == $especialidad->id) {
                                        $selected = 'selected';
                                    }
